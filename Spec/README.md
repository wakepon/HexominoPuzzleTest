...
2. [ゲームメカニクス](./game-mechanics.md) - コアゲームメカニクス（ブロック配置、衝突判定等）
3. [データ構造](./data-structures.md) - 型定義とデータモデル
4. [状態管理](./state-management.md) - ゲーム状態とアクション
5. [UI・描画システム](./ui-rendering.md) - Canvas描画とユーザーインタラクション
6. [レイアウトシステム](./layout-system.md) - レスポンシブレイアウト計算
