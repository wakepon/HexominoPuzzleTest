...
パターン・シール・加護の付与確率はミノサイズに関わらず一律である。それぞれ独立して判定される。
...
- パターン・シール・加護の付与判定は独立して行われる（複数が同時に付与されることもある）
- 付与されるパターンの種類はショップ出現可能なものからランダムに均等選択
- 加護についての詳細は [blessing-system.md](./blessing-system.md) を参照
...
- 2026-02-22: ショップ確率表に加護付与確率15%を追加、blessing-system.mdへのリンク追加
